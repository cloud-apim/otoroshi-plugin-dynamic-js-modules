# Contributing to Dynamic Js Modules

These guidelines apply to all projects living in the the `cloud-apim/otoroshi-plugin-dynamic-js-modules` repository.
...
* [src](https://github.com/cloud-apim/otoroshi-plugin-dynamic-js-modules/src): contains the Dynamic Js Modules sources and tests
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/cloud-apim/otoroshi-plugin-dynamic-js-modules/issues) and [existing pull requests](https://github.com/cloud-apim/otoroshi-plugin-dynamic-js-modules/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/cloud-apim/otoroshi-plugin-dynamic-js-modules/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/cloud-apim/otoroshi-plugin-dynamic-js-modules#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline Dynamic Js Modules.
